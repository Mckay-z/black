        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 mb-24">
            ...
            <div className="bg-surface p-10 md:p-16 rounded-3xl border border-border">
              <h2 className="text-primary font-medium tracking-widest uppercase mb-6 text-sm">Our Mission</h2>
            ...
            {/* Vision */}
            <div className="bg-surface p-10 md:p-16 rounded-3xl border border-border">
              <h2 className="text-primary font-medium tracking-widest uppercase mb-6 text-sm">Our Vision</h2>
              <p className="text-2xl md:text-3xl lg:text-4xl font-serif font-bold text-foreground leading-tight">
      ...
      <section className="py-24 bg-surface border-t border-border">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-primary font-medium tracking-widest uppercase mb-4 text-sm">What Drives Us</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {VALUES.map((value, idx) => (
              <div key={idx} className="bg-background border border-border rounded-2xl p-8 hover:border-primary/50 transition-colors text-center flex flex-col items-center">
