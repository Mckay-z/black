        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {FORMATS.map((format) => (
              <div
                key={format.title}
                className="bg-background border border-border rounded-2xl p-6 flex items-center gap-4"
              >
              ...
              <div key={group.theme}>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  {group.topics.map((topic) => (
                    <div
                      key={topic.title}
                      className="bg-surface border border-border rounded-2xl p-8 flex flex-col hover:border-primary/50 transition-colors"
                    >
