...
export default function StudentSupportPage() {
  return (
    <div className="bg-background min-h-screen">
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            {BARRIERS.map((item) => (
              <div
                key={item.label}
                className="bg-background border border-border rounded-2xl p-10 text-center"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            {SUPPORTS.map((support) => (
              <Link
                key={support.title}
                href={support.href}
                className="group bg-surface border border-border rounded-2xl p-8 hover:border-primary/50 transition-colors flex flex-col"
              >
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <div className="bg-surface border border-border rounded-3xl p-10 md:p-16 flex flex-col md:flex-row items-center justify-between gap-10">
