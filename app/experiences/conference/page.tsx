    ...
    <div className="bg-background min-h-screen">
      ...
      <section id="agenda" className="py-24 bg-background">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl">
          <h2 className="text-3xl md:text-4xl font-serif font-bold text-foreground mb-12 text-center">Conference Agenda</h2>
          <div className="space-y-6">
            {AGENDA.map((item, idx) => (
              <div key={idx} className="bg-surface border border-border rounded-2xl p-8 flex flex-col sm:flex-row gap-6 hover:border-primary/50 transition-colors">
