    ...
    <div className="bg-background min-h-screen">
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <Link
            href={featured.href}
            className="group grid grid-cols-1 lg:grid-cols-2 bg-surface border border-border rounded-3xl overflow-hidden hover:border-primary/50 transition-colors"
          >
            <FillerImage
              src={featured.image}
              alt={featured.title}
            ...
            <div className="p-10 flex flex-col justify-center">
              ...
              <h3 className="text-3xl md:text-4xl font-serif font-bold text-foreground mb-4 group-hover:text-primary transition-colors">
                {featured.title}
              </h3>
