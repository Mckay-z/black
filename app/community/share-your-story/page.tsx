...
export default function ShareYourStoryPage() {
  return (
    <div className="bg-background min-h-screen">
      ...
      {/* The form */}
      <section id="story-form" className="py-24 bg-background scroll-mt-24">
        <div className="container mx-auto px-4 md:px-6 max-w-3xl">
          ...
          */}
          ...
          <div className="mt-10 flex items-start gap-3 bg-surface border border-border rounded-2xl p-6">
