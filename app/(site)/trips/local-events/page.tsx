...
export const metadata = unlistedMetadata({
  title: "Local Events | Black In Rehab Foundation",
});
  ...
  return (
    <div className="bg-background min-h-screen">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {UPCOMING.map((item) => (
              <div
                ...
                className="group card card-sunken overflow-hidden card-hover"
              >
                <FillerImage
                  src={item.image}
      ...
      <CTABand
        ...
        secondaryCta={{ label: "See All Events", href: "/trips/upcoming-events" }}
      />
    </div>
  );
}
