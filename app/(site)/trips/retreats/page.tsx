...
/*
  Unlisted: this trip is not in the client's "Events updates" calendar, so
  it is no longer in `lib/trips.ts` or the menus. The page is kept and still
  resolves — see `UNLISTED` in `lib/navigation.ts` for the reason — but it
  should not be a search result, because nobody has confirmed the trip.
*/
export const metadata = unlistedMetadata({
  title: "Wellness Retreat | Black In Rehab Foundation",
});
  ...
  return (
    <div className="bg-background min-h-screen">
      ...
      <section className="section-dark relative py-32 md:py-40 overflow-hidden bg-secondary">
        ...
        <div className="container relative z-10 mx-auto px-4 md:px-6">
          <div className="flex items-center gap-2 text-sm font-medium text-primary mb-6">
            ...
            <Link href="/trips" className="hover:text-primary-hover">Trips</Link>
            <span className="text-white/40">/</span>
          ...
          <Link href="/trips/retreats/register" className="btn btn-primary btn-lg group">
      ...
      <section className="section bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16">
            <h2 className="display-2 text-foreground mb-4">The Four Pillars of Our Retreat</h2>
      ...
      <section className="section bg-surface border-t border-border">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="display-2 text-foreground mb-12 text-center">A Taste of the Experience</h2>
      ...
      <section className="section-dark py-24 bg-secondary border-y border-border">
        <div className="container mx-auto px-4 md:px-6 text-center">
          <h2 className="display-2 text-white mb-6">Your Renewal Awaits</h2>
