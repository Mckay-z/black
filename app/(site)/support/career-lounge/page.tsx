...
export default function CareerLoungePage() {
  return (
    <div className="bg-background min-h-screen">
      ...
      {/* Openings */}
      <section id="openings" className="section bg-surface border-y border-border scroll-mt-24">
        <div className="container mx-auto px-4 md:px-6">
          <SectionHeading
          ...
          <div className="space-y-4">
            {OPENINGS.map((opening, idx) => (
              <div
                key={idx}
                className="card card-sunken p-7 flex flex-col md:flex-row md:items-center justify-between gap-5 card-hover"
              >
