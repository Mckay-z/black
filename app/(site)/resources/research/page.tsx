...
export const metadata = unlistedMetadata({
  title: "Research | Black In Rehab Foundation",
});
const PUBLICATIONS = [
  {
...
export default function ResearchPage() {
  return (
    <div className="bg-background min-h-screen">
      ...
      {/* Publications */}
      <section id="publications" className="section bg-surface border-y border-border scroll-mt-24">
        <div className="container mx-auto px-4 md:px-6">
          <SectionHeading
          ...
          <div className="space-y-6">
            {PUBLICATIONS.map((pub) => (
              <div
                key={pub.title}
                className="card card-sunken p-8 flex flex-col md:flex-row md:items-center justify-between gap-6 card-hover"
              >
