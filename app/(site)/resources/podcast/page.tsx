        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="space-y-6">
            {EPISODES.map((episode) => (
              <div
                key={episode.number}
                className="group grid grid-cols-1 md:grid-cols-4 card rounded-3xl overflow-hidden card-hover"
              >
                <FillerImage
                  src={episode.image}
                  alt={episode.title}
      ...
      <section className="section bg-surface border-y border-border">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <div className="grid grid-cols-1 gap-3 mt-8">
                {TOPICS.map((topic) => (
                  <div
                    key={topic}
                    className="flex items-center gap-3 card card-sunken rounded-xl p-4 card-hover"
                  >
            ...
            <div className="card card-sunken rounded-3xl p-10">
