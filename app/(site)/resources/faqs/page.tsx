    ...
    <div className="bg-background min-h-screen">
      ...
      <section className="section bg-background">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl">
              ...
              <div key={group.id} id={group.id} className="scroll-mt-40">
                ...
                <div className="space-y-4">
                  {group.items.map((item) => (
                    <details
                      key={item.q}
                      className="group card overflow-hidden transition-colors hover:border-primary/50 open:border-primary/50"
                    >
          ...
          {/* Still stuck */}
          <div className="mt-20 card rounded-3xl p-10 md:p-12 text-center">
