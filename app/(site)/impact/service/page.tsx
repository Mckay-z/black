    ...
    <div className="bg-background min-h-screen">
      ...
      <section className="py-24">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              <h2 className="eyebrow mb-5">Our Approach</h2>
              <h3 className="display-2 text-foreground mb-6">Healing Where It&apos;s Needed Most</h3>
            ...
            <div className="space-y-4">
              {IMPACT_STATS.map((stat, idx) => (
                <div key={idx} className="flex items-start gap-3 card rounded-xl p-4">
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {PROGRAMS.map((program, idx) => (
              <div key={idx} className="card card-sunken p-8 card-hover">
      ...
      <section className="section bg-background border-t border-border">
        <div className="container mx-auto px-4 md:px-6 text-center">
          <h2 className="display-2 text-foreground mb-4">Get Involved</h2>
          <p className="text-muted text-lg mb-10 max-w-xl mx-auto">
            Volunteer on a service trip, partner with us locally, or support our programs through a donation.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/experiences/ghana" className="btn btn-primary btn-lg group">
              GLOBAL EXPERIENCES <ArrowRight className="w-5 h-5" />
            </Link>
            <Link href="/impact/donate" className="btn btn-outline btn-lg">
              SUPPORT OUR WORK
            </Link>
          </div>
        </div>
