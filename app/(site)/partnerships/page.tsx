  ...
  return (
    <div className="bg-background min-h-screen">
      ...
      <section className="section bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16">
            <h2 className="eyebrow mb-5">Partnership Opportunities</h2>
            <h3 className="display-2 text-foreground">Who We Partner With</h3>
          </div>
      ...
      <section className="section bg-surface border-t border-border">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16">
            <h2 className="eyebrow mb-5">Sponsorship</h2>
            <h3 className="display-2 text-foreground">Choose Your Investment Level</h3>
          </div>
      ...
      <section className="section bg-background border-t border-border">
        <div className="container mx-auto px-4 md:px-6 text-center">
          <h2 className="display-2 text-foreground mb-4">Need a Custom Package?</h2>
